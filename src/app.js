...
import { palabraAleatoria } from "./components/palabra-aleatoria";
...
export const App = (elementId) => {
  ...
  const star__aleatorio = document.querySelector(".star__aleatorio");
  ...
  star__aleatorio.addEventListener("click", () => {
    const indiceAleatorio = Math.floor(Math.random() * palabraAleatoria.length);
    palabra = palabraAleatoria[indiceAleatorio].toUpperCase();
    star__position.style.display = "none";
    game__send.disabled = false;
    game__input.disabled = false;
    game__reload.disabled = false;
